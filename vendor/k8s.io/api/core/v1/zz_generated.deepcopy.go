...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *P9VolumeSource) DeepCopyInto(out *P9VolumeSource) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new P9VolumeSource.
func (in *P9VolumeSource) DeepCopy() *P9VolumeSource {
	if in == nil {
		return nil
	}
	out := new(P9VolumeSource)
	in.DeepCopyInto(out)
	return out
}
